...
Use this sidecar when `text-layout-invalidation` needs deeper detail on diagnosing stale layout, profiling invalidation cost, or understanding viewport controller behavior beyond the model overview in the main skill.
