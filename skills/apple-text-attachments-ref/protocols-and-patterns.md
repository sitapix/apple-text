...
Use this sidecar when `apple-text-attachments-ref` needs the lower-level protocols, insertion recipes, or compatibility matrix without loading them into every attachment question.
