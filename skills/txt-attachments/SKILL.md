...
Keep this file for the attachment model, view-provider lifecycle, and adaptive glyph choice. For protocol signatures, insertion patterns, copy-paste rules, and support matrices, use [protocols-and-patterns.md](references/protocols-and-patterns.md).
...
- For protocol signatures, insertion recipes, and support matrices, see [protocols-and-patterns.md](references/protocols-and-patterns.md).
- Use `/skill txt-formatting` for non-attachment attributed-text formatting.
- Use `/skill txt-textkit2` for fragment and viewport behavior around attachments.
- Use `/skill txt-fallback-triggers` when attachment choices may force compatibility mode.
