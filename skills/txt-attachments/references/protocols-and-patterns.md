...
Use this sidecar when `txt-attachments` needs the lower-level protocols, insertion recipes, or compatibility matrix without loading them into every attachment question.
