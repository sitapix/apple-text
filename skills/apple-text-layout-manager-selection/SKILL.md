...
- Use `/skill apple-text-textkit1-ref` or `/skill apple-text-textkit2-ref` after you know which stack you need.
- Use `/skill apple-text-fallback-triggers` when compatibility mode is driving the decision.
