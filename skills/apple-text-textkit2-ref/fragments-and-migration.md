...
Use this sidecar when the main `apple-text-textkit2-ref` skill needs deeper detail on fragment internals, viewport controller hooks, object-based ranges, or TextKit 1 migration mapping.
