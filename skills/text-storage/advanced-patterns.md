...
Use this sidecar when `text-storage` needs deeper detail on custom backing stores, thread-safe access, performance measurement, or TextKit 2 content manager subclassing beyond the basics in the main skill.
