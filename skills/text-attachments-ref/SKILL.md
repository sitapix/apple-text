...
- Use `/skill text-formatting-ref` for non-attachment attributed-text formatting.
- Use `/skill text-textkit2-ref` for fragment and viewport behavior around attachments.
- Use `/skill text-fallback-triggers` when attachment choices may force compatibility mode.
