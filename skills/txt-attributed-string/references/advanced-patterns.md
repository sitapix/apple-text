...
Use this sidecar when `txt-attributed-string` needs deeper detail on custom scopes, paragraph-style setup, or the attribute catalog without loading every appendix into the main skill.
