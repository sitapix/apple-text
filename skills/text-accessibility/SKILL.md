...
description: Use when making custom text editors accessible — VoiceOver support for UITextView wrappers, Dynamic Type in custom editors, accessibility value updates during editing, UIAccessibilityTextualContext, making UIViewRepresentable text views work with assistive technology, or custom text view accessibility traits
license: MIT
---
...
- Need Dynamic Type font scaling -> `/skill text-dynamic-type`
- Need color contrast for text -> `/skill text-colors`
- Need UIViewRepresentable wrapping -> `/skill text-representable`
...
- Use `/skill text-dynamic-type` for comprehensive Dynamic Type patterns.
- Use `/skill text-colors` for color contrast and accessibility colors.
- Use `/skill text-representable` for UIViewRepresentable wrapping patterns.
- Use `/skill text-views` for choosing accessible text views.
