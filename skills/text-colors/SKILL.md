...
- Need advanced formatting attributes -> `/skill text-formatting-ref`
...
- Use `/skill text-formatting-ref` for broader attributed-text formatting rules.
- Use `/skill text-dynamic-type` when color decisions interact with accessibility text sizing.
- Use `/skill text-attributed-string` when the color question is really about attribute storage and conversion.
