...
- Route to `/skill apple-text-appkit-vs-uikit` if the user is comparing an iOS port
...
- Route to `/skill apple-text-textkit2-ref` or `/skill apple-text-textkit1-ref` based on API needs
