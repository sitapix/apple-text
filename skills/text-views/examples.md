...
- Route to `/skill text-appkit-vs-uikit` if the user is comparing an iOS port
...
- Route to `/skill text-textkit2-ref` or `/skill text-textkit1-ref` based on API needs
