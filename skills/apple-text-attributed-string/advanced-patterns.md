...
Use this sidecar when `apple-text-attributed-string` needs deeper detail on custom scopes, paragraph-style setup, or the attribute catalog without loading every appendix into the main skill.
