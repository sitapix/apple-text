...
- Use `/skill apple-text-representable` when SwiftUI wrapping is part of the platform decision.
- Use `/skill apple-text-writing-tools` for Apple Intelligence editor differences.
