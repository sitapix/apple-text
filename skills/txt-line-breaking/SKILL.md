...
- For paragraph style attribute reference -> `/skill txt-formatting`
- For text measurement with these settings -> `/skill txt-measurement`
- For Dynamic Type scaling interaction -> `/skill txt-dynamic-type`
- For multi-column layout with different line settings -> `/skill txt-exclusion-paths`
