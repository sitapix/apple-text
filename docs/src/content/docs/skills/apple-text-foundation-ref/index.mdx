---
title: "Foundation Text Utilities Reference"
...
This page documents the `apple-text-foundation-ref` reference skill. Use it when the subsystem is already known and you need mechanics, behavior, or API detail.
