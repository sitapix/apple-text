---
title: "Text Colors, Dark Mode & Wide Color"
...
Use when choosing text colors, semantic colors, dark mode adaptation, or wide-color/HDR text across UIKit, AppKit, and SwiftUI.
...
This page documents the `apple-text-colors` reference skill. Use it when the subsystem is already known and you need mechanics, behavior, or API detail.
