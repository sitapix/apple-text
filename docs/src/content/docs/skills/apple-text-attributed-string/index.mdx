---
title: "Attributed String Reference"
...
Use when choosing between AttributedString and NSAttributedString, defining custom attributes, or converting between them.
