---
title: "TextKit 2 Reference"
description: "Use when the user is already on TextKit 2 and needs exact NSTextLayoutManager, NSTextContentManager, NSTextContentStorage, viewport layout, fragment, rendering-attribute, or migration details. Reach for this when the stack choice is already made and the task is reference-level TextKit 2 mechanics, not stack selection or generic text-system debugging."
---
...
This page documents the `apple-text-textkit2-ref` reference skill. Use it when the subsystem is already known and you need mechanics, behavior, or API detail.
...
- `skills/apple-text-textkit2-ref/fragments-and-migration.md`
