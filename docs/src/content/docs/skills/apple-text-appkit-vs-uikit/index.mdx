---
title: "AppKit vs UIKit Text Capabilities"
...
Use when comparing NSTextView and UITextView capabilities or porting editor behavior between macOS and iOS.
...
This page documents the `apple-text-appkit-vs-uikit` decision skill. Use it when the main task is choosing the right Apple text API, view, or architecture.
