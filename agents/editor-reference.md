...
|-------|----------|-------|----------|
| writing tools | writing tools, apple intelligence editor, uiwritingtoolscoordinator | `apple-text-writing-tools` | — |
| interaction | context menu, link tap, cursor, selection, gestures, uieditmenuinteraction | `apple-text-interaction` | — |
| input reference | uitextinput, nstextinputclient, marked text | `apple-text-input-ref` | scribble-patterns.md |
| undo | undo, redo, undo manager, undo grouping, undo coalescing | `apple-text-undo` | — |
| find replace | find, replace, search, uifindinteraction, nstextfinder | `apple-text-find-replace` | — |
| pasteboard | paste, copy, cut, clipboard, pasteboard, nsitemprovider | `apple-text-pasteboard` | — |
| spell autocorrect | spell checking, autocorrect, uitextchecker, nsspellchecker, autocorrection | `apple-text-spell-autocorrect` | — |
| drag drop | drag, drop, uitextdraggable, uitextdroppable, text drag, text drop | `apple-text-drag-drop` | — |
| accessibility | voiceover, accessibility, dynamic type editor, screen reader, assistive technology | `apple-text-accessibility` | — |
| dynamic type | dynamic type, font scaling, uifontmetrics | `apple-text-dynamic-type` | — |
